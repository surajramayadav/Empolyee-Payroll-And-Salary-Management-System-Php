...
<h3 class="text-warning text-center" > Employee Data </h3><br>
 ...
 <td> <button class="btn-danger btn"> <a href="deletesalary.php?id=<?php echo $res['id']; ?>" class="text-white"> Delete </a>  </button> </td>
 <td> <button class="btn-primary btn"> <a href="updatesalaryslip.php?id=<?php echo $res['id']; ?>" class="text-white"> Update </a> </button> </td>
